...
open_project "$root/build/vivado_project/sine_dds_project.xpr"
...
save_bd_design
generate_target all [get_files "$root/build/vivado_project/sine_dds_project.srcs/sources_1/bd/$bd_name/$bd_name.bd"]
make_wrapper -files [get_files "$root/build/vivado_project/sine_dds_project.srcs/sources_1/bd/$bd_name/$bd_name.bd"] -top
add_files -norecurse "$root/build/vivado_project/sine_dds_project.gen/sources_1/bd/$bd_name/hdl/${bd_name}_wrapper.v"
