...
set project "$root/build/vivado_project/sine_dds_project.xpr"
set bd_file "$root/build/vivado_project/sine_dds_project.srcs/sources_1/bd/sine_dds_bd/sine_dds_bd.bd"
