# Source with: vivado -mode batch -source scripts/create_project.tcl
set root [file normalize [file join [file dirname [info script]] ..]]
create_project sine_dds_project "$root/build/vivado_project" -part xc7z020clg484-2 -force
add_files "$root/rtl/sine_dds.sv"
add_files "$root/rtl/sine_lut.mem"
set_property top sine_dds [current_fileset]
update_compile_order -fileset sources_1

# Give the GUI the same driven behavioral simulation used by scripts/run_sim.tcl.
